...
const app = getApp()
const { addKillsActivity, updateKillsActivity, canUseCardList, uploadImg } = api
...
Page({
    ...
    sure(){
        ...
        let submitData = {}
        let reqUrl = actId ? updateKillsActivity : addKillsActivity
                ...
                wx.uploadFile({
                    ...
                    success: function(res){
                        ...
                        if(res.statusCode == 200) {
                            ...
                            that.data.showlist[10].value = that.data.alyunFilePath
                            that.setData({
                                showlist:that.data.showlist,
