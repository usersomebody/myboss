...
Page({
    ...
    recordTimeData(time){
        ...
        request({
            ...
            success:(res)=>{
                console.log('res',res)
                this.setData({
                    isHasData:res.fitness_test_time ? true : false,
                    editId:res.fitness_test_time ? res.id : ''
                })
            }
        })
    },
    ...
    sure(e){
        ...
        isPass = {...isPass,...{sex,age,phone,type:vipType}}

        let url = isHasData ? editRecord : addRecord
        request({
            url:baseUrl + url,
            data:isPass,
            method:'POST',
